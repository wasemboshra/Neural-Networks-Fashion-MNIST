...
4. Project Structure & Requirements Checklist
 Data Preprocessing: Images normalized and labels encoded using One-Hot encoding.
 Model Architecture: MLP structure initialized using standard Sequential.
 Loss & Performance Monitoring: Categorical Crossentropy applied.
 Visualization: Training vs Validation loss and accuracy curves plotted.
